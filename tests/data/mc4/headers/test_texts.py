# flake8: noqa
none_character_text = """เล่มที่2 บทที่ 41 ต่างหูแห่งการต่อต้าน...
...
none_tone_mark_text = """แผนพ ฒนาค ณภาพ มหาว ทยาล ยพาย พ ป การศ กษา 2555
...
gamble_text = """ฝากเงิน การแทงบอล ยังไงให้ปลอดถัยที่สุด
...
football_text = """Lปาร์ม่า3 - 0อตาลันต้า - กัลโช่ เซเรีย อา
...
hotel_ad_text = """โรงแรมอันดับ 1 จาก 4 แห่ง ใน a Petropolis
...
sale_text = """พิเศษสำหรับ ลูกค้าใหม่สั่งครั้งแรก คลิกที่นี่ เพื่อรับส่วนลด$10 เมื่อสั่งสินค้าครบ $40 (หากสั่งต่ำกว่า $40 จะได้รับส่วนลด $5) ขาย วิตามิน อาหารเสริม ราคาถูก วิธีสั่งของ iherb pantip รีวิว คูปองส่วนลด
...
rent_text = """ให้เช่า บ้านมือสอง ใกล้ MRT แยกติวานนท์ | The Nation
...
ghost_text = """แผนที่ เธฃเน�เธฒเธ�เธญเธฒเธซเธฒเธฃเธ�เน�เธฒเธ�เธ�เธฃเธนเธญเธตเน�เธ� เน�เธ�เธฃ.038-612-261 จังหวัดระยอง :: แผนที่ประเทศไทย , Thailand-Map-Guide.com
...
url_text = """http://www.dobrolubie.ru/forum/index.php?showuser=59153
...
menu1_text = """| 18/05/61 | เปิดดู 2285 | หมวด คอนโดมิเนียม | กรุงเทพมหานคร | ดูแผนที่
...
menu2_text = """อาไวเกมส์เยือนแพ้รวด ทีเด็ดบอลวางฟลูมิเนนเซเบาๆ
...
hashtag_text = """เมกเกอร์หญิงรุ่นเล็กขอแสดงฝีมือ        3,947 views     More +#จัดปาร์ตี้สละโสด #แต่งงาน #มาร์กี้ #ดาราแต่งงาน #นางเอง #มาร์กี้แต่งงาน #ว่าที่สะไภ้หมื่นล้าน #มิ้นคิมร่วมปาร์ตี้ #ราศี
...
markup_text = """{{ kv.owner.preferred_name | truncate:25 }}{{ kv.owner.fullname | truncate:40 }} ผู้ติดตาม: {{ kv.owner.follower_count | number }} ติดตาม: {{ kv.owner.followee_count | number }} ติดต่อ ติดตาม เลิกติดตาม {{ kv.owner.preferred_name | truncate:25 }}{{ kv.owner.fullname | truncate:40 }}
...
embedded_server_text = """<% if ( total_view > 0 ) { %> <%= total_view > 1 ? "total views" : "total view" %> <% if ( today_view > 0 ) { %> <%= today_view > 1 ? "views today" : "view today" %> no views today       No views yet <% uncompleted format"""

u_text = """ต่อไป<U+FEFF><U+FEFF> โครงการบ้านศรุตาปา
...
iframe_text = """<iframe src='https://vod.thaipbs.or.th/videos/Qnm8mDJnNHJf/embedded?title=%E0%B8%97%E0%B8%B1%E0%B9%88%E0%B8%A7%E0%B8%96%E0%B8%B4%E0%B9%88%E0%B8%99%E0%B9%81%E0%B8%94%E0%B8%99%E0%B9%84%E0%B8%97%E0%B8%A2+-+%E0%B8%AD%E0%B8%B4%E0%B9%88%E0%B8%A1%E0%B8%AA%E0%B8%B8%E0%B8%82%E0%B8%97%E0%B8%B5%E0%B9%88%E0%B8%9A%E0%B9%89%E0%B8%B2%E0%B8%99%E0%B8%9A%E0%B8%B2%E0%B8%87%E0%B9%80%E0%B8%9A%E0%B9%89%E0%B8%B2+%E0%B8%AB%E0%B8%B8%E0%B8%9A%E0%B9%80%E0%B8%82%E0%B8%B2%E0%B8%A5%E0%B9%89%E0%B8%AD%E0%B8%A1%E0%B8%97%E0%B8%B0%E0%B9%80%E0%B8%A5+%E0%B8%88.%E0%B8%95%E0%B8%A3%E0%B8%B2%E0%B8%94&image=https%3A%2F%2Fthaipbs-program.s3-ap-southeast-1.amazonaws.com%2Fcontent%2Fimages%2Fepisode%2F1%2FF1%2F2F%2F1F12F0bpOUtP-large.jpg&tags=%7B%22video_category%22%3A%22show%22%2C%22program%22%3A%22tuathin%22%2C%22category%22%3A%22lifestyle%22%7D' border='0' width='640px;' height='360px;' allowfullscreen allow='autoplay; fullscreen' class='watch-embedded-player'></iframe> มีข้อความต่อเนื่อง  ที่มีประโยชน์   <iframe kljlj </iframe>       นี่ก็อีกข้อความหนึ่งที่มีประโยชน์ เช่นกัน    <iframe abcdef ghijk</iframe>klkjkljklj    <iframe hello world   </iframe>  มีข้อมูลต่อ  <iframe width="560" height="315" src=" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen allowtransparency><  เจาะลึกโทรศัพท์มือถือสำหรับเล่นเกม (Gaming Mobile) ที่มาพร้อมสเปกแรงจัดเต็ม โดยความเป็นจริงแล้วแตกต่   <iframe      
...
block_text = "สวัสดีครับ [abcdefghi] วันนี้อากาศร้อน [asdfgsgsdg] ระวังโรคลมแดด [abcdefg][...]« ตอบ ข้อความที่อยู่ระหว่าง » เดี๋ยวไม่สบาย << ก็มันร้อนจริงๆ  >>"

email_text = """Email : r_faisu@hotmail.comเครื่องบดสมุนไพร เพื่อทำยาป้องกันโรคต่างๆ - เครื่องบดยาสมุนไพร คุณภาพเยี่ยมราคาถูก ได้มาตรฐานระดับสากล ISO จัดส่งฟรีทั่วประเทศ : Inspired by LnwShop.com
...
ip_text = """By dallas zip code (210.1.31.28) on 14:15
...
date_text = """โดย Teetawat » พุธ 19 มิ.ย. 2019 11:51 am
...
hex_text = """E0B89F Tesla-E0 B9 89 E0 miniB8 B2 ระบบเครื่องยนต์E0 B9 E0-version
