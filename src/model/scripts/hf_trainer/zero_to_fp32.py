...
from deepspeed.utils import logger  # type: ignore
from deepspeed.checkpoint.constants import (  # type: ignore
    DS_VERSION,
...
class zero_model_state:
    buffers: dict()  # type: ignore
    param_shapes: dict()  # type: ignore
    shared_params: list
    ds_version: int
    frozen_param_shapes: dict()  # type: ignore
    frozen_param_fragments: dict()  # type: ignore
